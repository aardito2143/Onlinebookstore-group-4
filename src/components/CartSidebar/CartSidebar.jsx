...
export default function CartSidebar (props) {
    ...
    return (
        <div className='cart-sidebar-container'>
            <div className="cart-sidebar-subtotal">SubTotal: ${(Math.round((props.totalCost) * 100 ) / 100 ).toFixed(2)}</div>
                            ...
                            <div className='cart-sidebar-item'>
                                ...
                                <div style={{ display: 'flex', width: '100%', justifyContent: 'center', gap: '10px' }}>
                                    <select
                                        ...
                                        onChange={(e) => 
                                            props.updateQuantity(cartItem.id, Number(e.target.value)).then(
                                                (updatedQty) => {
                                                    setQty(updatedQty);
                                                }
                                            )}
                                    ...
                                    <button 
                                        ...
                                        onClick={() => props.removeItem(cartItem.id)}>

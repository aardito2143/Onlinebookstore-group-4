                ...
                <nav className="dashnav">
                    <div className="dashnav-upper-options">
                        <div className="dashnav-option option1">
                            <svg xmlns="http://www.w3.org/2000/svg" width="40" height="35" fill="#084887" className="bi bi-house-fill" viewBox="0 0 16 16">
                        ...
                        <div className="dashnav-option option2">
                            ...
                            <h3><Link to="/dashboard/add-product">Books</Link></h3>
                        </div>
